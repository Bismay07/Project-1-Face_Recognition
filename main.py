...
bismay_image = face_recognition.load_image_file("/Users/bismay/Documents/Python/Project-1-Face_Recognition/faces/bismay.jpg")
# encode the face
bismay_encodeings = face_recognition.face_encodings(bismay_image)[0]
known_faces_encodings = [bismay_encodeings]
known_faces_names = ["Bismay Bibhu Prakash"]
...
f = open(f"/Users/bismay/Documents/Python/Project-1-Face_Recognition/Attendance/{current_date}.csv", "a", newline="")
